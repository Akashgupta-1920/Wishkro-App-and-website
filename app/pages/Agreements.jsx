...
export default function TermsConditionsScreen() {
  ...
  return (
    <SafeAreaView style={[styles.safe, isWeb && styles.webSafe]}>
      <StatusBar
        translucent
      ...
      >
        <View style={[styles.card, isWeb && styles.webCard]}>
          <Text style={[styles.h1, isWeb && styles.webH1]}>WishKro:</Text>
          <Text style={[styles.h2, isWeb && styles.webH2]}>
            Terms & Conditions
          </Text>
          ...
          <Text style={[styles.section, isWeb && styles.webSection]}>
          ...
          {renderSection("10. Indemnification", [
            "You agree to indemnify and hold harmless WishKro and its affiliates from any claims, losses, damages, or expenses arising from your use of the Services or violation of these Terms.",
          ])}
          ...
          {renderSection("12. Governing Law", [
            "These Terms are governed by the laws of [Insert Jurisdiction/Country]. Any disputes will be resolved in the courts of [Insert Location].",
          ])}
          ...
          <TouchableOpacity
            style={[styles.closeBtn, isWeb && styles.webCloseBtn]}
            onPress={() => router.back()}
          >
            <Text
              style={[styles.closeBtnText, isWeb && styles.webCloseBtnText]}
            >
              Close
            </Text>
          </TouchableOpacity>
